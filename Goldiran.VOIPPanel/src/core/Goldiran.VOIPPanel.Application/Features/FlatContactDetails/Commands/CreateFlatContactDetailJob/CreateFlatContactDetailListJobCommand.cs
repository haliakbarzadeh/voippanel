...
public class CreateFlatContactDetailListJobCommand : BaseCreateCommandRequest, IRequest<FlatContactDetailResponse>
{
    ...
    public class Handler : IRequestHandler<CreateFlatContactDetailListJobCommand, FlatContactDetailResponse>
    {
        ...
        public async Task<FlatContactDetailResponse> Handle(CreateFlatContactDetailListJobCommand request, CancellationToken cancellationToken)
        {
            ...
            var existList=_mapper.Map<List<ContactDetailDto>>(_readModelContext.Set< Goldiran.VOIPPanel.ReadModel.Entities.ContactDetail>().AsNoTracking().OrderByDescending(c=>c.Id).Take(30).ToList());
        ...
        private async Task<PaginatedList<ContactDetailDto>> GetContactDetails(CreateFlatContactDetailListJobCommand request, CancellationToken cancellationToken)
        {
        ...
        private async Task UpdateLastDataJob(CreateFlatContactDetailListJobCommand request, FlatContactDetailResponse contactDetail, CancellationToken cancellationToken)
        {
